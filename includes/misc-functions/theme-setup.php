...
/* ------------------------------------ */
function mp_knapstack_fix_embeds( $html ) {
    return '<div class="video-container">' . $html . '</div>';
}
add_filter( 'embed_oembed_html', 'mp_knapstack_fix_embeds', 10, 3 );
add_filter( 'video_embed_html', 'mp_knapstack_fix_embeds' ); // Jetpack
